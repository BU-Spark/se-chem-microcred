...
// checker grading the rubric, which moves the badge to IN_REVIEW; the student then
...
export async function POST(_request: Request, context: RouteContext) {
  ...
  return NextResponse.json(
    { error: 'Student self-finalization has been removed; assessments are submitted by a checker.' },
    { status: 410 }
  );
}
