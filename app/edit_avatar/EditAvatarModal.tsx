...
function FacePreview({ option, large = false }: { option: FaceOption; large?: boolean }) {
  ...
  return (
    <svg className={className} viewBox="0 0 160 160" role="img" aria-hidden>
      <circle cx={80} cy={80} r={80} fill={option.baseColor} />
...
export default function EditAvatarPage({ onClose }: EditAvatarModalProps = { onClose: () => {} }) {
                  ...
                  <button
                    ...
                    onClick={() =>
                      setSelectedFaces((prev) => ({
                        ...prev,
                        [selectedAvatar]: faceData.prev!.id,
                      }))
                    }
                ...
                {faceData.options.length > 1 ? (
                  <button
                    ...
                    onClick={() =>
                      setSelectedFaces((prev) => ({
                        ...prev,
                        [selectedAvatar]: faceData.next!.id,
                      }))
                    }
                  ...
                  <button
                    ...
                    onClick={() =>
                      setSelectedAccessories((prev) => ({
                        ...prev,
                        [selectedAvatar]: accessoryData.prev!.id,
                      }))
                    }
                ...
                {accessoryData.options.length > 1 ? (
                  <button
                    ...
                    onClick={() =>
                      setSelectedAccessories((prev) => ({
                        ...prev,
                        [selectedAvatar]: accessoryData.next!.id,
                      }))
                    }
